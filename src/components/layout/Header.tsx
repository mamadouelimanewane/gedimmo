...
<div className={styles.navItem}>
                    ...
                    <div className={styles.navItem}>
                        <Link href="/legal-assistant" className={styles.navLink}>Assistant IA</Link>
                    </div>
...
<div style={{ padding: '12px 24px 4px', fontSize: '12px', color: '#666', fontWeight: 'bold', textTransform: 'uppercase' }}>Je suis un pro</div>
                ...
                <div className={styles.actions}>
                    {/* NOUVEAUX LIENS MODULES SPÉCIAUX */}
                    <Link href="/diaspora" className={styles.navLink} style={{ color: '#D4AF37', fontWeight: 'bold' }}>Diaspora</Link>
                    <Link href="/extranet-communes" className={styles.navLink} style={{ color: '#D4AF37', fontWeight: 'bold' }}>Communes</Link>
                    <Link href="/blockchain" className={styles.navLink} style={{ color: '#D4AF37', fontWeight: 'bold' }}>Blockchain</Link>
